...
| operator.image | object | `{"repository":"ghcr.io/slinkyproject/slurm-operator","tag":null}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| webhook.image | object | `{"repository":"ghcr.io/slinkyproject/slurm-operator-webhook","tag":null}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
